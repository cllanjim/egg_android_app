...
/**
 * 文件名: UnShareCameraToOthersMgmt
 * 描    述: 取消分享给其他人
 * 创建人:刘波
 * 创建时间: 2015/9
 */
public class UnShareCameraToOthersMgmt extends BaseMgmt {

    public BaseCallBack mBaseCallBack;
    private String mCid, mShareNickName;

    public void unShareCamaraToOther(Context context, String cid, String shareNickName,
    ...
    protected String getRequestUrl() {
        return String.format("%s/share/remove", APP_REQUEST_URL);
    }
