...
public class RoundedVignetteBitmapDisplayer extends RoundedBitmapDisplayer {
    ...
    public RoundedVignetteBitmapDisplayer(int cornerRadiusPixels, int marginPixels, int cornors) {
        super(cornerRadiusPixels, marginPixels, cornors);
    }
    ...
    public void display(Bitmap bitmap, ImageAware imageAware, LoadedFrom loadedFrom) {
        ...
        imageAware.setImageDrawable(new RoundedVignetteDrawable(bitmap, cornerRadius, margin, cornors));
    }

    protected static class RoundedVignetteDrawable extends RoundedDrawable {

        RoundedVignetteDrawable(Bitmap bitmap, int cornerRadius, int margin, int cornors) {
            super(bitmap, cornerRadius, margin, cornors);
        }
