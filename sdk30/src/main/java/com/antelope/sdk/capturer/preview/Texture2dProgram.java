...
public class Texture2dProgram {
    ...
    public Texture2dProgram(ProgramType programType) {
        ...
        CLog.d("Created program " + mProgramHandle + " (" + programType + ")");
     ...
     */
    public void release() {
        CLog.d("deleting program " + mProgramHandle);
    ...
    public void setKernel(float[] values, float colorAdj) {
        ...
        //CLog.d("filt kernel: " + Arrays.toString(mKernel) + ", adj=" + colorAdj);
    }
    ...
    public void setTexSize(int width, int height) {
        ...
        //CLog.d("filt size: " + width + "x" + height + ": " + Arrays.toString(mTexOffset));
    }
    ...
    public void draw(float[] mvpMatrix, FloatBuffer vertexBuffer, int firstVertex,
            ...
            float[] texMatrix, FloatBuffer texBuffer, int textureId, int texStride,int mode) {
        ...
        // Draw the rect. 绘制矩形 GLES20.GL_TRIANGLE_STRIP 按条状绘制，重复利用前面三角形的后面两个点坐标
        //GLES20.GL_TRIANGLE_FAN 扇形绘制  重复利用第一个点，一般用于画圆，第一个点为圆心
        //GLES20.GL_TRIANGLE 三角形绘制  必须给出每个三角形的三个点坐标 
//        GLES20.glDrawArrays(GLES20.GL_TRIANGLE_STRIP, firstVertex, vertexCount);
//        GLES20.glDrawArrays(GLES20.GL_TRIANGLE_FAN, firstVertex, vertexCount);
