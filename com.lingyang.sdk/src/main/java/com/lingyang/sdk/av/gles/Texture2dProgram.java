...
public class Texture2dProgram {
     ...
     * @param triangleType     {@link GLES20#GL_TRIANGLE_STRIP } or {@link  GLES20#GL_TRIANGLE_FAN}
     */
    public void draw(float[] mvpMatrix, FloatBuffer vertexBuffer, int firstVertex,
                     int vertexCount, int coordsPerVertex, int vertexStride,
                     float[] texMatrix, FloatBuffer texBuffer, int textureId,
                     int texStride, int triangleType) {
        ...
        // Draw the rect.
        GLES20.glDrawArrays(triangleType, firstVertex, vertexCount);
